...
human_ <- filter(human, complete.cases(human) == TRUE) # modify the "TRUE", see instructions above!
...
# visualize the 'human_' variablevs
ggpairs(human_)
...
biplot(pca_human, choices = 1:2, cex = c(0.4, 0.8), col = c("grey40", "deeppink2"))
